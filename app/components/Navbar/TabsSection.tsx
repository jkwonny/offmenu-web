    ...
    return (
        <div className="flex rounded-full border border-[#06048D] overflow-hidden">
            <Link
                ...
                className={`p-2 md:px-6 md:py-1.5 text-xs md:text-sm font-medium transition-colors whitespace-nowrap ${!view || view === 'spaces'
            ...
            <Link
                ...
                className={`p-2 md:px-6 md:py-1.5 text-xs md:text-sm font-medium transition-colors whitespace-nowrap ${view === 'popups'
                    ? 'bg-[#06048D] text-white'
                    : 'bg-white text-black'
                    }`}
            >
