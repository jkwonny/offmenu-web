...
import { Clock, MapPin, Edit, Trash2, CheckCircle } from 'lucide-react';
        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="container mx-auto px-4 py-8 flex-grow">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    ...
                    {(eventData.image_url || eventData.event_images) && (() => {
                        const allImages = [
                            ...(eventData.image_url || []).map(img => img.image_url || ''),
                            ...(eventData.event_images || []).map(img => img.image_url)
                        ].filter(Boolean);
                        ...
                        if (allImages.length === 1) {
                            return (
                                <div className="mb-8">
                                    <div className="relative aspect-[4/3] rounded-lg overflow-hidden max-w-2xl">
                                        <Image
                                            src={allImages[0]}
