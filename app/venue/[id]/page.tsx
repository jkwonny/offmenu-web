        ...
        <div className="min-h-screen bg-[#FFF9F5]">
            ...
            <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            {venue?.tags && venue.tags.map((tag, index) => (
                                <span key={`tag-${index}`} className="text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded-full capitalize">
                                    {tag}
                                </span>
                            ))}
                        </div>
                ...
                {venue?.venue_images && Array.isArray(venue.venue_images) && venue.venue_images.length > 0 ? (
                    <div className="relative w-full overflow-hidden">
                        <div className="flex items-center">
                            ...
                            {venue.venue_images.length > 1 && (
                                <div className="relative w-1/4 h-[30vh] opacity-50 mr-2">
                                    <Image
                            ...
                            {/* Current image (center, larger) */}
                            <div className="relative w-full h-[40vh] mx-2 flex-grow">
                                <Image
                            ...
                            {venue.venue_images.length > 1 && (
                                <div className="relative w-1/4 h-[30vh] opacity-50 ml-2">
                                    <Image
                    ...
                    <div className="w-full h-[40vh] bg-gray-200 flex items-center justify-center rounded-lg">
            ...
            {isModalOpen && (
                ...
                >
                    <div
                        className="bg-white rounded-xl w-full max-w-lg relative p-2"
